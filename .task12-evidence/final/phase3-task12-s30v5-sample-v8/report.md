...
|---:|---|---:|---:|---:|
| 17 | Vampire mesh FOF 96 | 247 / 232 | 1,519 | 0 / 0 |
| 18 | E mesh FOF 128 | 86 / 84 | 1,198 | 0 / 0 |
| 19 | Zipperposition mesh TH1 128 | 24 / 22 | 466 | 0 / 0 |
| 20 | Vampire mesh TX0 512 | 34 / 16 | 353 | 0 / 0 |
| 21 | E mepo FOF 512 | 37 / 35 | 811 | 0 / 0 |
| 22 | Vampire mepo FOF 1024 | 194 / 181 | 1,459 | 0 / 0 |
| 23 | E mash TX0- 128 | 23 / 19 | 364 | 0 / 0 |
| 24 | Vampire mash FOF 256 | 194 / 184 | 1,456 | 0 / 0 |

By filter, mesh supplied 391/354 winner P/R rows, mepo 231/216, and mash
217/203; overlapping success totals were 3,536, 2,270, and 1,820. No new
slice was the sole successful slice on a sampled goal, so every
anchor-exclusive value is zero. These are sampled Phase 8 seeds only.
...
`8effa531ad5aef62e6b8f56bbd0504c4b8407e12befebae3f0fa793205093800`
and `137259d9878b472c814eb9cc40ba68a8d25d64e67b71b294c07a82163537ae67`.

The frozen-verifier inventory is
`36d8c2676705796bf25553efeb595ee618bb249f7c8976581d1a8d3ab8021bdb`.
...
cleanup tests pass. The maintained extraction reproduces the hard-bound
...
are `b47fe45f96854e7f1ae838208207e5184891b85175325d41bec085c59b99566e`
...
`91664d1bf05147f9704f2fc47d024414d9e39e364f9ca37416886e6d37d94ef2`.
