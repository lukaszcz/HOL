...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "bool$EQ_IMP_THM" "bool" "EQ_IMP_THM"),
benchLib.FactAdd (benchExplicit.named_at "option$option_induction" "option" "option_induction")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.FactAdd (benchExplicit.named_specialized "option$FORALL_OPTION[of-not-P]" ``(∀opt. (λoption_value. ¬v_P0 option_value) opt) ⇔
(λoption_value. ¬v_P0 option_value) NONE ∧
∀x. (λoption_value. ¬v_P0 option_value) (SOME x)``)]),
 excl = [],
...
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.SplitAdd (benchExplicit.named_at "parityTranslation$source_option_split" "parityTranslation" "source_option_split"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_map_option_case" "parityTranslation" "source_map_option_case")]),
 excl = [{name = "optionAutoSeed$OPTION_MAP_EQ_NONE_AUTO", theorem = #theorem (benchExplicit.named_at "optionAutoSeed$OPTION_MAP_EQ_NONE_AUTO" "optionAutoSeed" "OPTION_MAP_EQ_NONE_AUTO")},
{name = "option$OPTION_MAP_EQ_NONE", theorem = #theorem (benchExplicit.named_at "option$OPTION_MAP_EQ_NONE" "option" "OPTION_MAP_EQ_NONE")}],
...
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.SplitAdd (benchExplicit.named_at "parityTranslation$source_option_split" "parityTranslation" "source_option_split"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_rel_option_iff" "parityTranslation" "source_rel_option_iff")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_rel_option_unfold" "parityTranslation" "source_rel_option_unfold")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "option$FORALL_OPTION" "option" "FORALL_OPTION")]),
 excl = [],
...
v_B0 ≠ ∅ ∧ v_B0 ≠ {NONE}``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_these_empty_eq" "parityTranslation" "source_these_empty_eq"),
benchLib.IntroAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_no_some_member_none" "parityTranslation" "source_no_some_member_none")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "pred_set$INJECTIVE_IMAGE_FINITE" "pred_set" "INJECTIVE_IMAGE_FINITE")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_UNIV_option_conv" "parityTranslation" "source_UNIV_option_conv"),
benchLib.RewriteAdd (benchExplicit.named_at "pred_set$INJECTIVE_IMAGE_FINITE" "pred_set" "INJECTIVE_IMAGE_FINITE")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$SPECIFICATION" "pred_set" "SPECIFICATION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.DefinitionAdd (benchExplicit.named_at "option$IS_NONE_DEF" "option" "IS_NONE_DEF")]),
 excl = [],
