...
benchLib.RewriteAdd (benchExplicit.named_at "pair$PAIR_EQ" "pair" "PAIR_EQ")]),
 excl = [],
...
{id = "list_L1001_hd_append2",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_hd_append" "parityTranslation" "source_hd_append")]),
 excl = [],
...
(λb_list_nil b_list_cons b_list_value.
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.SplitAdd (benchExplicit.named_at "parityTranslation$source_list_split" "parityTranslation" "source_list_split"),
...
{id = "list_L1007_tl_append2",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_tl_append" "parityTranslation" "source_tl_append")]),
 excl = [],
...
{id = "list_L1010_tl_append_if",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_tl_append" "parityTranslation" "source_tl_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$list_case_compute" "list" "list_case_compute"),
benchLib.RewriteAdd (benchExplicit.named_at "list$NULL_EQ" "rich_list" "NULL_EQ_NIL")]),
 excl = [],
...
MAP v_f0 v_xs0 = MAP v_g0 v_ys0``,
 source_method = "by simp",
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "list$MAP_EQ_f" "rich_list" "MAP_EQ_f")]),
 excl = [],
...
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_map_inj_on" "parityTranslation" "source_map_inj_on")]),
 excl = [],
...
(MAP v_f0 v_xs0 = MAP v_f0 v_ys0 ⇔ v_xs0 = v_ys0)``,
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_map_injective" "parityTranslation" "source_map_injective")]),
 excl = [],
...
(λb_inj_func b_inj_set. INJ b_inj_func b_inj_set 𝕌(:β)) v_f0 𝕌(:α)``,
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.IntroAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_inj_mapI" "parityTranslation" "source_inj_mapI"),
benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_inj_mapD" "parityTranslation" "source_inj_mapD")]),
 excl = [],
...
(λb_inj_func b_inj_set. INJ b_inj_func b_inj_set 𝕌(:β list)) (MAP v_f0) v_A0``,
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_map_inj_on" "parityTranslation" "source_map_inj_on"),
benchLib.IntroAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_inj_onI" "parityTranslation" "source_inj_onI"),
benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_inj_onD" "parityTranslation" "source_inj_onD")]),
 excl = [],
...
benchLib.DefinitionAdd (benchExplicit.named_at "combin$o_DEF" "combin" "o_DEF")]),
 excl = [],
...
{id = "list_L1287_rev_eq_Cons_iff",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_rev_swap" "parityTranslation" "source_rev_swap")]),
 excl = [],
...
(v_xs0 ++ v_ys0 = v_xs_0 ++ v_ys_0 ⇔ v_xs0 = v_xs_0 ∧ v_ys0 = v_ys_0)``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$APPEND_EQ_APPEND" "list" "APPEND_EQ_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_at "rich_list$NIL_NO_MEM" "rich_list" "NIL_NO_MEM")]),
 excl = [],
...
set
 ...
 source_method = "by auto",
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_TO_SET_GENLIST" "list" "LIST_TO_SET_GENLIST"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_num_offset_interval" "parityTranslation" "source_num_offset_interval"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_num_offset_open_interval" "parityTranslation" "source_num_offset_open_interval"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_num_offset_open_closed" "parityTranslation" "source_num_offset_open_closed"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_num_offset_closed" "parityTranslation" "source_num_offset_closed")]),
 excl = [],
...
{id = "list_L1415_in_set_conv_decomp",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.ElimAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_split_list" "parityTranslation" "source_split_list"),
benchLib.FactAdd (benchExplicit.named_at "parityTranslation$source_split_list_fact" "parityTranslation" "source_split_list")]),
 excl = [],
...
{id = "list_L1431_in_set_conv_decomp_first",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_split_list_first" "parityTranslation" "source_split_list_first")]),
 excl = [],
...
{id = "list_L1448_in_set_conv_decomp_last",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_split_list_last" "parityTranslation" "source_split_list_last")]),
 excl = [],
...
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_split_list_prop" "parityTranslation" "source_split_list_prop")]),
...
v_thesis0``,
 ...
 recipe = benchLib.AllGoals (
benchLib.Invoke (benchLib.Safe,
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_split_list_first_prop" "parityTranslation" "source_split_list_first_prop")]),
benchLib.Invoke (benchLib.Blast,
[])),
 excl = [],
...
v_thesis0``,
 ...
 recipe = benchLib.AllGoals (
benchLib.Invoke (benchLib.Safe,
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_split_list_last_prop" "parityTranslation" "source_split_list_last_prop")]),
benchLib.Invoke (benchLib.Blast,
[])),
 excl = [],
...
(v_xs0 ++ v_x0::v_ys0 = v_xs_0 ++ v_x0::v_ys_0 ⇔
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$APPEND_EQ_APPEND" "list" "APPEND_EQ_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_at "list$APPEND_EQ_CONS" "list" "APPEND_EQ_CONS"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_Cons_eq_append_conv" "parityTranslation" "source_Cons_eq_append_conv")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_concat_eq_concat_iff_curried" "parityTranslation" "source_concat_eq_concat_iff_curried")]),
benchLib.AllGoals (
benchLib.Invoke (benchLib.Safe,
[]),
benchLib.Invoke (benchLib.Simp,
...
if v_xss0 = [] then v_ys0 = [] ∧ v_zs0 = []
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_concat_eq_appendD" "parityTranslation" "source_concat_eq_appendD"),
benchLib.FactAdd (benchExplicit.named_at "parityTranslation$source_concat_eq_appendD_fact" "parityTranslation" "source_concat_eq_appendD")]),
 excl = [],
...
{id = "list_L1706_length_filter_map",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "rich_list$FILTER_MAP" "rich_list" "FILTER_MAP"),
benchLib.DefinitionAdd (benchExplicit.named_at "combin$o_DEF" "combin" "o_DEF")]),
 excl = [],
...
∃b_us b_vs.
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.FactAdd (benchExplicit.named_at "parityTranslation$source_filter_eq_ConsD" "parityTranslation" "source_filter_eq_ConsD"),
benchLib.IntroAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_filter_eq_ConsI" "parityTranslation" "source_filter_eq_ConsI")]),
 excl = [],
...
(λb_nth_list b_nth_index. b_nth_list❲b_nth_index❳) v_xs0 (v_n0 − 1)``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "rich_list$EL_CONS" "rich_list" "EL_CONS"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$PRE_SUB1" "arithmetic" "PRE_SUB1")]),
 excl = [],
...
(λb_nth_list b_nth_index. b_nth_list❲b_nth_index❳) v_xs0 v_i0``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "rich_list$EL_APPEND1" "rich_list" "EL_APPEND1"),
benchLib.RewriteAdd (benchExplicit.named_at "rich_list$EL_APPEND2" "rich_list" "EL_APPEND2")]),
 excl = [],
...
[benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_EQ_REWRITE" "list" "LIST_EQ_REWRITE"),
benchLib.FactAdd (benchExplicit.named_at "list$LIST_EQ_REWRITE_context" "list" "LIST_EQ_REWRITE"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_MAP" "rich_list" "LENGTH_MAP"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_MAP" "rich_list" "EL_MAP"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_LUPDATE" "combinatorics" "LUPDATE_LEN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_TAKE" "rich_list" "LENGTH_FIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_TAKE_EQ" "list" "LENGTH_TAKE_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_DROP" "rich_list" "LENGTH_BUTFIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_take" "parityTranslation" "source_lt_length_take"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_drop" "parityTranslation" "source_lt_length_drop"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_LUPDATE" "list" "EL_LUPDATE"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_TAKE" "rich_list" "EL_FIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_DROP" "rich_list" "EL_BUTFIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$NOT_LESS" "arithmetic" "NOT_LESS"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$LESS_EQ_ANTISYM" "arithmetic" "LESS_EQ_ANTISYM"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$LESS_EQ_ADD" "arithmetic" "LESS_EQ_ADD"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD_COMM" "arithmeticAutoSeed" "ADD_COMM_ALGEBRA"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_less_not_ge" "parityTranslation" "source_less_not_ge"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_not_add_less_left" "parityTranslation" "source_not_add_less_left")]),
 excl = [],
...
∃b_i.
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "pred_set$IN_APP" "pred_set" "IN_APP"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_set_conv_nth" "parityTranslation" "source_set_conv_nth"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_ZIP_MIN" "list" "LENGTH_ZIP_MIN"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_el_zip_min" "parityTranslation" "source_el_zip_min"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fst_el_zip_min" "parityTranslation" "source_fst_el_zip_min"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_snd_el_zip_min" "parityTranslation" "source_snd_el_zip_min"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_TAKE" "rich_list" "LENGTH_FIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_DROP" "rich_list" "LENGTH_BUTFIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_TAKE" "rich_list" "EL_FIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_DROP" "rich_list" "EL_BUTFIRSTN"),
...
v_A0``,
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_set_update_subset_insert" "parityTranslation" "source_set_update_subset_insert"),
benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_subsetD" "parityTranslation" "source_subsetD")]),
 excl = [],
...
{id = "list_L2088_hd_Nil_eq_last",
 ...
 source_method = "by simp",
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_hd_def" "parityTranslation" "source_hd_def"),
benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_last_def" "parityTranslation" "source_last_def")]),
 excl = [],
...
{id = "list_L2097_last_ConsL",
 ...
 source_method = "by simp",
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "list$LAST_DEF" "list" "LAST_DEF")]),
 excl = [],
...
{id = "list_L2106_last_appendL",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_last_append" "parityTranslation" "source_last_append"),
benchLib.DefinitionAdd (benchExplicit.named_at "list$LAST_DEF" "list" "LAST_DEF")]),
 excl = [],
...
MEM v_x0 (FRONT (v_xs0 ++ v_ys0))``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_front_append" "parityTranslation" "source_front_append"),
benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_mem_front" "parityTranslation" "source_mem_front")]),
 excl = [],
...
if v_k0 = LENGTH v_xs0 − 1 then v_x0 else LAST v_xs0``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$LAST_EL" "list" "LAST_EL"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_LUPDATE" "list" "EL_LUPDATE"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_LUPDATE" "combinatorics" "LUPDATE_LEN"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$PRE_SUB1" "arithmetic" "PRE_SUB1"),
benchLib.DefinitionAdd (benchExplicit.named_at "list$LAST_DEF" "list" "LAST_DEF")]),
...
v_ys0 ≠ [] ∧ FRONT v_ys0 = v_xs0 ∧ LAST v_ys0 = v_x0``,
 ...
 recipe = benchLib.Invoke (benchLib.Fastforce,
[benchLib.RewriteAdd (benchExplicit.named_specialized "list$SNOC_APPEND[symmetric]" ``∀x l. l ++ [x] = SNOC x l``),
benchLib.RewriteAdd (benchExplicit.named_at "list$SNOC_LAST_FRONT" "list" "SNOC_LAST_FRONT")]),
 excl = [],
...
{id = "list_L2214_take_Suc",
 ...
 recipe = benchLib.Invoke (benchLib.Clarsimp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_neq_nil_conv" "parityTranslation" "source_neq_nil_conv")]),
 excl = [],
...
{id = "list_L2396_butlast_take",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_front_by_take" "parityTranslation" "source_front_by_take"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_TAKE" "rich_list" "LENGTH_FIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$TAKE_TAKE_MIN" "list" "TAKE_TAKE_MIN"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$MIN_EQ_LE" "arithmetic" "MIN_EQ_LE"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$SUB_LESS_EQ" "arithmetic" "SUB_LESS_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$SUB_LEFT_LESS_EQ" "arithmetic" "SUB_LEFT_LESS_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$LESS_EQ" "arithmetic" "LESS_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD1" "arithmetic" "ADD1")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$LESS_EQ" "arithmetic" "LESS_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD1" "arithmetic" "ADD1"),
benchLib.RewriteAdd (benchExplicit.named_at "list$DROP_TAKE" "list" "DROP_TAKE"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_DROP" "rich_list" "LENGTH_BUTFIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$SUB_RIGHT_SUB" "arithmeticAutoSeed" "SUB_RIGHT_SUB_ALGEBRA"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD_COMM" "arithmeticAutoSeed" "ADD_COMM_ALGEBRA")]),
 excl = [],
...
(λb_nth_list b_nth_index. b_nth_list❲b_nth_index❳) v_xs0 v_n0``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_specialized "list$HD_CONV_EL" ``∀l. HD l = l❲0❳``),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_DROP" "rich_list" "EL_BUTFIRSTN"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD_CLAUSES" "arithmetic" "ADD_CLAUSES")]),
 excl = [],
...
if ∀b_x. MEM b_x v_xs0 ⇒ v_P0 b_x then v_xs0 ++ source_takeWhile v_P0 v_ys0
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_append1" "parityTranslation" "source_takeWhile_append1"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_append2" "parityTranslation" "source_takeWhile_append2"),
benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_def" "parityTranslation" "source_takeWhile_def"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_all" "parityTranslation" "source_takeWhile_all"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_none" "parityTranslation" "source_takeWhile_none"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_replicate_hd_disjunction" "parityTranslation" "source_replicate_hd_disjunction"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_replicate_hd_disjunction_neg" "parityTranslation" "source_replicate_hd_disjunction_neg"),
benchLib.RewriteAdd (benchExplicit.named_at "rich_list$EVERY_REPLICATE" "rich_list" "ALL_EL_REPLICATE")]),
 excl = [],
...
{id = "list_L2576_dropWhile_id",
 ...
 recipe = benchLib.Invoke (benchLib.Fastforce,
[benchLib.FactAdd (benchExplicit.named_specialized "parityTranslation$source_takeWhile_dropWhile_id" ``source_takeWhile v_P0 v_xs0 ++ dropWhile v_P0 v_xs0 = v_xs0``),
benchLib.FactAdd (benchExplicit.named_specialized "parityTranslation$source_takeWhile_eq_nil_iff" ``source_takeWhile v_P0 v_xs0 = [] ⇔ v_xs0 = [] ∨ ¬v_P0 (HD v_xs0)``),
benchLib.FactAdd (benchExplicit.named_at "rich_list$HEAD_MEM" "rich_list" "HEAD_MEM")]),
 excl = [],
...
if ∀b_x. MEM b_x v_xs0 ⇒ v_P0 b_x then dropWhile v_P0 v_ys0
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_dropWhile_append1" "parityTranslation" "source_dropWhile_append1"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_dropWhile_append2" "parityTranslation" "source_dropWhile_append2")]),
 excl = [],
...
{id = "list_L2589_dropWhile_last",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.FactAdd (benchExplicit.named_specialized "rich_list$IS_SUFFIX_dropWhile" ``IS_SUFFIX v_xs0 (dropWhile v_P0 v_xs0)``),
benchLib.FactAdd (benchExplicit.named_specialized "parityTranslation$source_dropWhile_nonempty" ``EXISTS ($¬ ∘ v_P0) v_xs0 ⇒ dropWhile v_P0 v_xs0 ≠ []``),
benchLib.FactAdd (benchExplicit.named_specialized "parityTranslation$source_last_suffix" ``IS_SUFFIX v_xs0 (dropWhile v_P0 v_xs0) ⇒
dropWhile v_P0 v_xs0 ≠ [] ⇒
LAST (dropWhile v_P0 v_xs0) = LAST v_xs0``),
benchLib.RewriteAdd (benchExplicit.named_at "list$EXISTS_MEM" "list" "EXISTS_MEM"),
benchLib.DefinitionAdd (benchExplicit.named_at "list$LAST_DEF" "list" "LAST_DEF")]),
 excl = [],
...
ZIP (v_xs0 ++ v_ys0,v_us0 ++ v_vs0) = ZIP (v_xs0,v_us0) ++ ZIP (v_ys0,v_vs0)``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_zip_append1" "parityTranslation" "source_zip_append1")]),
 excl = [],
...
MAP (λ(b_x,b_y). (v_f0 b_x,b_y)) (ZIP (v_xs0,v_ys0))``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.FactAdd (benchExplicit.zip_map1 ())]),
 excl = [],
...
MAP (λ(b_x,b_y). (b_x,v_f0 b_y)) (ZIP (v_xs0,v_ys0))``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.FactAdd (benchExplicit.zip_map2 ())]),
 excl = [],
...
MAP (λ(b_x,b_y). v_f0 (v_g0 b_x,b_y)) (ZIP (v_xs0,v_ys0))``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_zip_map1" "parityTranslation" "source_zip_map1"),
benchLib.RewriteAdd (benchExplicit.named_at "list$MAP_MAP_o" "rich_list" "MAP_MAP_o"),
benchLib.RewriteAdd (benchExplicit.named_at "pair$LAMBDA_PROD" "pair" "LAMBDA_PROD"),
benchLib.DefinitionAdd (benchExplicit.named_at "combin$o_DEF" "combin" "o_DEF")]),
 excl = [],
...
MAP (λ(b_x,b_y). v_f0 (b_x,v_g0 b_y)) (ZIP (v_xs0,v_ys0))``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_zip_map2" "parityTranslation" "source_zip_map2"),
benchLib.RewriteAdd (benchExplicit.named_at "list$MAP_MAP_o" "rich_list" "MAP_MAP_o"),
benchLib.RewriteAdd (benchExplicit.named_at "pair$LAMBDA_PROD" "pair" "LAMBDA_PROD"),
benchLib.DefinitionAdd (benchExplicit.named_at "combin$o_DEF" "combin" "o_DEF")]),
 excl = [],
...
(λb_update_list b_update_index b_update_item.
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_update_zip" "parityTranslation" "source_update_zip")]),
 excl = [],
...
v_R0``,
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_set_zip_leftD" "parityTranslation" "source_set_zip_leftD"),
benchLib.DestAdd (benchLib.UnsafeRule, benchExplicit.named_at "parityTranslation$source_set_zip_rightD" "parityTranslation" "source_set_zip_rightD")]),
 excl = [],
...
(ZIP (v_xs0,v_ys0) = v_zs0 ⇔ MAP FST v_zs0 = v_xs0 ∧ MAP SND v_zs0 = v_ys0)``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$MAP_ZIP" "list" "MAP_ZIP"),
benchLib.RewriteAdd (benchExplicit.named_at "list$UNZIP_MAP" "list" "UNZIP_MAP"),
benchLib.RewriteAdd (benchExplicit.named_at "list$ZIP_UNZIP" "rich_list" "ZIP_UNZIP"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_zip_map_fst_snd" "parityTranslation" "source_zip_map_fst_snd"),
benchLib.RewriteAdd (benchExplicit.named_at "pair$PAIR" "pair" "PAIR")]),
 excl = [],
...
{id = "list_L3010_list_all2_lengthD",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "list$EVERY2_EVERY" "list" "EVERY2_EVERY")]),
 excl = [],
...
{id = "list_L3014_list_all2_Nil",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "list$EVERY2_EVERY" "list" "EVERY2_EVERY")]),
 excl = [{name = "listAutoSeed$LIST_REL_NIL_LEFT_AUTO", theorem = #theorem (benchExplicit.named_at "listAutoSeed$LIST_REL_NIL_LEFT_AUTO" "listAutoSeed" "LIST_REL_NIL_LEFT_AUTO")},
{name = "list$LIST_REL_NIL",
 theorem = #theorem (benchExplicit.named "list$LIST_REL_NIL")}],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_zip_rev" "parityTranslation" "source_zip_rev")]),
 excl = [],
...
LIST_REL v_P0 (v_a0 ++ v_c0) (v_b0 ++ v_d0)``,
 ...
 recipe = benchLib.AllGoals (
benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_REL_APPEND_EQ" "list" "LIST_REL_APPEND_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_REL_APPEND_suff" "rich_list" "EVERY2_APPEND_suff"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EVERY2_LENGTH" "list" "EVERY2_LENGTH")]),
benchLib.AllGoals (
benchLib.Invoke (benchLib.Safe,
[]),
benchLib.Invoke (benchLib.Simp,
...
[benchLib.RewriteAdd (benchExplicit.named_at "list$EVERY2_EVERY" "list" "EVERY2_EVERY"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_set_zip" "parityTranslation" "source_set_zip")]),
 excl = [],
...
LIST_REL v_P0 v_a0 v_b0``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_REL_EL_EQN" "list" "LIST_REL_EL_EQN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_MAP" "rich_list" "EL_MAP")]),
 excl = [],
...
∀b_set. MEM b_set (ZIP (v_xs0,v_ys0)) ⇒ (λ(b_x,b_y). b_x = b_y) b_set``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_REL_eq" "list" "LIST_REL_eq"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_EQ_REWRITE" "list" "LIST_EQ_REWRITE"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_REL_EL_EQN" "list" "LIST_REL_EL_EQN"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_MAP" "rich_list" "EL_MAP"),
benchLib.CongruenceAdd (benchExplicit.named_at "parityTranslation$source_conj_cong" "parityTranslation" "source_conj_cong"),
...
{id = "list_L3286_rev_conv_fold",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_Cons_rev" "parityTranslation" "source_fold_Cons_rev")]),
 excl = [],
...
(λb_fold_function b_fold_list b_fold_initial.
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "bool$FUN_EQ_THM" "bool" "FUN_EQ_THM"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_Diff_eq_symmetric" "parityTranslation" "source_Diff_eq_symmetric"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_minus_set_fold" "parityTranslation" "source_minus_set_fold"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "pred_set$IN_DELETE" "pred_set" "IN_DELETE"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_mem_fold_delete" "parityTranslation" "source_mem_fold_delete")]),
 excl = [],
...
FOLDL (λb_x b_y. v_f0 b_y b_x) v_a0 (REVERSE v_xs0)``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_eta" "parityTranslation" "source_fold_eta"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_foldr_conv_fold" "parityTranslation" "source_foldr_conv_fold"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_foldl_conv_fold" "parityTranslation" "source_foldl_conv_fold"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND"),
benchLib.IntroAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_fold_cong" "parityTranslation" "source_fold_cong")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND")]),
 excl = [{name = "rich_list$FOLDR_APPEND", theorem = #theorem (benchExplicit.named_at "rich_list$FOLDR_APPEND" "rich_list" "FOLDR_APPEND")}],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_foldl_conv_fold" "parityTranslation" "source_foldl_conv_fold"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append")]),
 excl = [{name = "rich_list$FOLDL_APPEND", theorem = #theorem (benchExplicit.named_at "rich_list$FOLDL_APPEND" "rich_list" "FOLDL_APPEND")}],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_map" "parityTranslation" "source_fold_map"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_map_eta" "parityTranslation" "source_fold_map_eta"),
benchLib.RewriteAdd (benchExplicit.named_specialized "list$MAP_REVERSE[symmetric]" ``∀l f. REVERSE (MAP f l) = MAP f (REVERSE l)``),
benchLib.DefinitionAdd (benchExplicit.named_at "combin$o_DEF" "combin" "o_DEF")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_specialized "list$FILTER_REVERSE[symmetric]" ``∀l P. REVERSE (FILTER P l) = FILTER P (REVERSE l)``),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_filter" "parityTranslation" "source_fold_filter"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_filter_eta" "parityTranslation" "source_fold_filter_eta")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_map" "parityTranslation" "source_fold_map"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_map_eta" "parityTranslation" "source_fold_map_eta")]),
 excl = [{name = "rich_list$FOLDL_MAP", theorem = #theorem (benchExplicit.named_at "rich_list$FOLDL_MAP" "rich_list" "FOLDL_MAP")}],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append" "parityTranslation" "source_fold_append"),
benchLib.RewriteAdd (benchExplicit.named_at "list$REVERSE_APPEND" "rich_list" "REVERSE_APPEND"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_fold_append_concat_rev" "parityTranslation" "source_fold_append_concat_rev")]),
 excl = [],
...
v_i0::
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd
   (benchExplicit.named_once_at "parityTranslation$source_upt_rec"
      "parityTranslation" "source_upt_rec")]),
 excl = [],
...
(λb_upt_start b_upt_end.
 ...
 source_method = "by (simp add: upt_rec)",
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_tl_num_genlist" "parityTranslation" "source_tl_num_genlist"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$PRE_SUB1" "arithmetic" "PRE_SUB1"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$ADD1" "arithmetic" "ADD1"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$SUB_PLUS" "arithmetic" "SUB_PLUS")]),
 excl = [],
...
((λb_nth_list b_nth_index. b_nth_list❲b_nth_index❳) v_xs0 v_i0 =
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "list$EL_ALL_DISTINCT_EL_EQ" "list" "EL_ALL_DISTINCT_EL_EQ")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_take" "parityTranslation" "source_lt_length_take"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_drop" "parityTranslation" "source_lt_length_drop"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_nth_eq_iff_index_eq" "parityTranslation" "source_nth_eq_iff_index_eq")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_take" "parityTranslation" "source_lt_length_take"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_lt_length_drop" "parityTranslation" "source_lt_length_drop"),
benchLib.IntroAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_inj_on_nth" "parityTranslation" "source_inj_on_nth"),
...
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "list$EL_LUPDATE" "list" "EL_LUPDATE")]),
benchLib.Invoke (benchLib.Aesop,
[benchLib.RewriteAdd (benchExplicit.named_at "bool$FUN_EQ_THM" "bool" "FUN_EQ_THM"),
benchLib.RewriteAdd (benchExplicit.named_at "pred_set$IN_APP" "pred_set" "IN_APP"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_set_conv_nth" "parityTranslation" "source_set_conv_nth"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_ZIP_MIN" "list" "LENGTH_ZIP_MIN"),
...
CARD (BIGUNION (IMAGE (λb_xs. set b_xs) (set v_xss0)))``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_length_nub_card" "parityTranslation" "source_length_nub_card"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_TO_SET_FLAT" "list" "LIST_TO_SET_FLAT"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LIST_TO_SET_MAP" "list" "LIST_TO_SET_MAP"),
...
{id = "list_L4464_in_set_insert",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "list$nub_def" "list" "nub_def"),
benchLib.RewriteAdd (benchExplicit.named_at "list$MEM_nub" "list" "MEM_nub")]),
 excl = [],
...
(λb_count_list b_count_item. LIST_ELEM_COUNT b_count_item b_count_list) v_xs0
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_count_list_zero" "parityTranslation" "source_count_list_zero")]),
 excl = [],
...
{id = "list_L4890_set_inter_list_set",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "bool$FUN_EQ_THM" "bool" "FUN_EQ_THM"),
benchLib.RewriteAdd (benchExplicit.named_at "list$FILTER_APPEND_DISTRIB" "rich_list" "FILTER_APPEND")]),
 excl = [],
...
{id = "list_L5001_in_set_replicate",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.RewriteAdd (benchExplicit.named_at "arithmeticAutoSeed$ZERO_LT_IMP_OR_ZERO_AUTO" "arithmeticAutoSeed" "ZERO_LT_IMP_OR_ZERO_AUTO"),
...
if v_P0 v_x0 then REPLICATE v_n0 v_x0 else []``,
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.FactAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_eq_nil_iff" "parityTranslation" "source_takeWhile_eq_nil_iff"),
benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_def" "parityTranslation" "source_takeWhile_def"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_all" "parityTranslation" "source_takeWhile_all"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_takeWhile_none" "parityTranslation" "source_takeWhile_none"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_replicate_hd_disjunction" "parityTranslation" "source_replicate_hd_disjunction"),
...
if v_P0 v_x0 then [] else REPLICATE v_n0 v_x0``,
 ...
 recipe = benchLib.Invoke (benchLib.Fastforce,
[benchLib.FactAdd (benchExplicit.named_specialized "parityTranslation$source_dropWhile_eq_self_iff" ``dropWhile v_P0 (REPLICATE v_n0 v_x0) = REPLICATE v_n0 v_x0 ⇔
REPLICATE v_n0 v_x0 = [] ∨ ¬v_P0 (source_hd (REPLICATE v_n0 v_x0))``),
benchLib.RewriteAdd (benchExplicit.named_at "list$dropWhile_eq_nil" "list" "dropWhile_eq_nil"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_hd_replicate" "parityTranslation" "source_hd_replicate"),
benchLib.RewriteAdd (benchExplicit.named_at "rich_list$EVERY_REPLICATE" "rich_list" "ALL_EL_REPLICATE")]),
 excl = [],
...
IMAGE (λ(b_xs,b_n). b_n::b_xs)
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.RewriteAdd (benchExplicit.named_at "bool$FUN_EQ_THM" "bool" "FUN_EQ_THM"),
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_EQ_SUC" "rich_list" "LENGTH_CONS")]),
 excl = [],
...
{id = "list_L5911_sorted_wrt1",
 ...
 source_method = "by(simp)",
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_def" "parityTranslation" "source_sorted_wrt_def")]),
 excl = [],
...
{id = "list_L5946_sorted_wrt_dropWhile",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_def" "parityTranslation" "source_sorted_wrt_def"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_dropWhile" "parityTranslation" "source_sorted_wrt_dropWhile")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "list$LENGTH_EQ_SUC" "rich_list" "LENGTH_CONS"),
benchLib.RewriteAdd (benchExplicit.named_at "arithmetic$LESS_EQ" "arithmetic" "LESS_EQ"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_length_le_one" "parityTranslation" "source_length_le_one")]),
 excl = [],
...
v_P0 v_xs0❲v_i0❳ v_xs0❲v_j0❳``,
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_def" "parityTranslation" "source_sorted_wrt_def"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_nth_less" "parityTranslation" "source_sorted_wrt_nth_less")]),
 excl = [],
...
{id = "list_L6208_sorted_upt",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_def" "parityTranslation" "source_sorted_wrt_def"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_sorted_wrt_upt" "parityTranslation" "source_sorted_wrt_upt")]),
 excl = [],
...
{id = "list_L8167_list_all_iff",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchExplicit.fragment "benchmark list predicate normalization"]),
 excl = [],
...
{id = "list_L8619_compl_coset",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$COMPL_DEF" "pred_set" "COMPL_DEF")]),
 excl = [],
...
{id = "list_L8638_filter_set",
 ...
 recipe = benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "list$MEM_FILTER" "listAutoSeed" "MEM_FILTER_AUTO"),
benchLib.RewriteAdd (benchExplicit.named_at "bool$CONJ_COMM" "bool" "CONJ_COMM")]),
 excl = [],
...
benchLib.RewriteAdd (benchExplicit.named_at "list$MEM_MAP" "list" "MEM_MAP")]),
 excl = [],
...
{id = "list_L8660_card_set",
 ...
 recipe = benchLib.Invoke (benchLib.Auto,
[benchLib.FactAdd (benchExplicit.named_specialized "list$nub_set_for_card_set" ``set (nub v_xs0) = set v_xs0``),
benchLib.FactAdd (benchExplicit.named_specialized "list$ALL_DISTINCT_CARD_LIST_TO_SET_for_nub" ``ALL_DISTINCT (nub v_xs0) ⇒ CARD (set (nub v_xs0)) = LENGTH (nub v_xs0)``),
benchLib.FactAdd (benchExplicit.named_specialized "list$all_distinct_nub" ``ALL_DISTINCT (nub v_xs0)``)]),
 excl = [],
...
benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_mem_product" "parityTranslation" "source_mem_product")]),
benchLib.Invoke (benchLib.Auto,
[])),
 excl = [],
...
benchLib.Invoke (benchLib.Simp,
[benchLib.DefinitionAdd (benchExplicit.named_at "pred_set$EXTENSION" "pred_set" "EXTENSION"),
benchLib.RewriteAdd (benchExplicit.named_at "parityTranslation$source_mem_relcomp" "parityTranslation" "source_mem_relcomp")]),
benchLib.Invoke (benchLib.Auto,
[])),
 excl = [],
...
{id = "list_L9013_list_all_transfer",
 ...
 recipe = benchLib.Invoke (benchLib.Blast,
[benchLib.DestAdd (benchLib.SafeRule, benchExplicit.named_at "parityTranslation$source_list_rel_all_mem" "parityTranslation" "source_list_rel_all_mem")]),
 excl = [],
