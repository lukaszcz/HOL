...
[
  ...
  ("zip_map_map[of f xs identity ys]",
   translated "source_zip_map_map"),
  ("zip_map_map[of identity xs f ys]",
   translated "source_zip_map_map"),
  ("zip_map1",
  ...
  ("lexord_def",
   translated "source_lexord_def"),
  ("trans_list_step_def",
   translated "source_trans_list_step_def"),
  ("equiv_def",
   translated "source_equiv_def"),
  ("listrel1p_def",
   translated "source_listrel1p_def"),
  ("lexordp_def",
   translated "source_lexordp_def"),
  ...
  ("lists_accI[THEN Cons_in_lists_iff[THEN iffD1, THEN conjunct1]]",
   unrepresented),
  ("nth_rotate[of n xs 1]", unrepresented),
  ("nth_transpose", unrepresented),
  ("possible_bit_def", unrepresented),
  ("ran_distinct", unrepresented),
  ...
  ("sorted_insort_key[where f=\"\\<lambda>x. x\"]", unrepresented),
  ("sorted_map_remove1[of \"\\<lambda>x. x\"]", unrepresented),
  ("sorted_map_same[of \"\\<lambda>x. x\"]", unrepresented),
  ("sorted_sort_key[where f=\"\\<lambda>x. x\"]", unrepresented),
  ("sorted_wrt01", unrepresented),
  ("sorted_wrt_append", unrepresented),
  ("sorted_wrt_drop", unrepresented),
  ("sorted_wrt_iff_nth_Suc_transp", unrepresented),
  ("sorted_wrt_map", unrepresented),
  ...
  ("inj_of_char",
   library "string" "ORD_11"),
  ("insort_insert_insort_key[of \"\\<lambda>x. x\"]",
   translated "source_insort_insert_insort"),
  ("insort_insert_key_triv[of \"\\<lambda>x. x\"]",
   translated "source_insort_insert_triv"),
  ("irrefl_def",
  ...
  ("lexord_same_pref_iff",
   translated "source_lexord_append_prefix_iff"),
  ("lexordp_conv_lexordp_eq",
   translated "source_lexordp_eq_def"),
  ("lexordp_iff",
   translated "source_lexordp_def"),
