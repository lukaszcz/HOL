...
fun entry id line representative method goal : benchLib.source_goal =
...
fun blast id line representative goal =
  entry id line representative "by blast" goal
...
val goals = benchDerive.prepare "classical" raw_goals
